  ...
  return (
    <div className="flex justify-between items-center px-10 bg-[#4A0906] dark:bg-[#081a24] text-white w-full h-20">
      ...
      <div className="flex gap-x-5 relative">
        ...
        {showProfileModal && (
          <div
            className="absolute top-12 right-4 bg-[brown] dark:bg-[#00337C] flex flex-col items-center w-52 py-5 px-3 rounded-xl"
          ...
          >
            ...
            <Link
              to="/"
              className="w-full bg-red-500 dark:bg-cyan-500 rounded-md my-1 flex items-center justify-around hover:bg-rose-300 mx-auto text-white hover:text-black duration-500 font-semibold p-3"
