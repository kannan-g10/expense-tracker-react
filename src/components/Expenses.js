  ...
  return (
    <div className="w-full md:w-1/3 lg:w-1/2 mx-auto">
      <div className="text-xl p-10 rounded font-semibold flex justify-center items-center gap-x-10">
        <h3 className="text-[#4A0906] dark:text-cyan-500 m-3 italic">
          Total Amount :
        ...
        <h3
          className="hover:text-[#4A0906] text-white flex gap-x-3 ring-4 ring-indigo-600 rounded-full bg-indigo-500 hover:bg-indigo-200 dark:hover:bg-violet-600 dark:text-white px-3 py-2 cursor-pointer"
          onClick={generateCSV}
        >
          Download
